...
if ($_POST['submit']) {
	...
	if ($error) {
		...
		mail("info@mgbourgeois.com", "Contact message", "Name: ".$_POST['name']."
		Email: ".$_POST['email']."
		Message: ".$_POST['message']);
        
        {
            // clesr the field after press submit button
            $_POST=array();
            
            // message if everything is ok with the fields
    	...
    	<div class="container">
    		...
    		<div class="row">
    			<div class="col-md-6 offset-md-3">
    				...
    				<p><br>Send a message via the form below</p>
